...
SELECT
    ...
    CASE
	    ...
	    WHEN d.age BETWEEN 1 AND 18 THEN 'Até 18 anos'
    ...
    END AS "age",
	count(a.customer_id) AS qtd_customers, 
    count(DISTINCT a.customer_id) AS qtd_unique_customers, 
	sum(device_total) AS qtd_device_total  
